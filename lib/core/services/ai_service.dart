...
class AIService {
  ...
  static const String _defaultApiKey = 'AIzaSyATujJ1kOd4yIvp7WG4eNRY4caaX7cS4l0';
...
Provide a thoughtful, logical, and persuasive response that challenges the user's position.
Use clear arguments, relevant evidence, and logical reasoning.
Keep your response concise (3-5 sentences) but impactful.
""";
